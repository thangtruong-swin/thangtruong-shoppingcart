     ...
     <article className="container">
      {cart.map((item) => (
        <div className="cart_box" key={item.id}>
          ...
          <div>
            <button className="btn btn-outline-primary btn-sm" onClick={() => handleChange(item, 1)}>+</button>
      ...
      {(cart.length) === 0 ?(<div className="container">
             <h4 className="text-center mt-3 text-info">Your Cart is empty for now.</h4>
                  </div>)
        :
        ( <div className="total">
